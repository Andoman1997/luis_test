...
declare global {
  ...
  const { createExpertCollection, createStickerCollection }: typeof import('../../utils/imageUtils')
  ...
  const { useCatImages }: typeof import('../../composables/useCatImages')
  ...
  const { useModal }: typeof import('../../composables/useModal')
  ...
  const { useSlider }: typeof import('../../composables/useSlider')
}
// for type re-export
declare global {
  // @ts-ignore
